...
export const metadata: Metadata = {
  ...
  description:
    "Browse the VibeKit Native component registry: 61 production-ready React Native components for auth, commerce, chat, profile, home, and UI. Install with one npx command.",
  alternates: { canonical: "/components" },
  openGraph: {
    title: "VibeKit Native Components — React Native registry",
    description:
      "61 production-ready React Native components for Expo apps. Auth, commerce, chat, profile, and UI primitives. Install with npx.",
