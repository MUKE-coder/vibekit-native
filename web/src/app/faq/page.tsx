...
const faqs: { q: string; a: string }[] = [
  {
    ...
    a: "VibeKit Native is a registry of 65 production-ready React Native components for Expo apps. Each component installs with a single npx command (npx vibekit-native install <name>) and drops into your project as an editable TypeScript file. All components share a dark-only design system with NativeWind v4 styling — consistent out of the box.",
  },
  {
