          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {templates.map((t) => (
              <Link
                ...
                className="group flex flex-col rounded-2xl card-glass p-6 transition-all hover:-translate-y-0.5 hover:border-[color:var(--border-strong)] hover:shadow-[var(--shadow-md)]"
              >
