...
export function ComponentRegistry() {
  return (
    <Section
      ...
      description="52 production-ready React Native components across 10 categories. Each one installs with a single npx command and shares the same dark design system."
    >
